...
return [
    ...
    'camera_back' => 'Back',
    'camera_wide' => 'Wide',
    'camera_ultrawide' => 'Ultra wide',
    'camera_telephoto' => 'Telephoto',
    'camera_macro' => 'Macro',
    'torch' => 'Light',
    'zoom' => 'Zoom',
    'sound_on' => 'Sound',
    ...
    // Permission help
    'permission_title' => 'How to enable camera permission:',
    'permission_ios' => 'Settings > Safari > Camera > Allow',
    'permission_android' => 'Tap the lock icon in the address bar > Permissions > Camera > Allow',
    'permission_chrome' => 'Click the lock icon next to the URL > Camera > Allow',
    'permission_firefox' => 'Click the lock icon > Permissions > Camera > Allow',
    'permission_reload' => 'After changing the permission, reload the page.',
];
